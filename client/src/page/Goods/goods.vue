    ...
    <div class="nav">
      ...
      <div class="w">
        ...
        <div class="price-interval">
          ...
          <input type="number" placeholder="价格" v-model="max" @keydown.enter="reset" ref="getBlur">
          <ctm-button text="确定" classStyle="main-btn" @btnClick="reset" style="margin-left: 10px;"></ctm-button>
        </div>
      </div>
    </div>
