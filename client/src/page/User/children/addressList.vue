<template>
  <div>
    <ctm-shelf title="收货地址">
      <span slot="right"><ctm-button text="添加收货地址" style="margin: 0" @btnClick="update()"></ctm-button></span>
      <div slot="content">
        ...
        <div v-else>
          <div style="padding: 80px 0;text-align: center">
            ...
            <div style="margin: 20px ">
              <ctm-button text="添加地址" @btnClick="update()"></ctm-button>
            </div>
          </div>
        </div>
      </div>
...
<script>
  ...
  import CtmPopup from '/components/popup'
