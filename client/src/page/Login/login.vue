<template>
  <div class="shop-page" v-loading.fullscreen.lock="!isFetched" element-loading-text="正在拼命加载中 ..." element-loading-background="rgba(255,255,255)">
    <div class="login v2" v-show="isFetched">
      <div class="wrapper">
        <div class="dialog dialog-shadow" style="display: block; margin-top: -362px;">
          <div class="title" v-if="loginPage">
            <h4>使用 HigherLoft ID 登录官网</h4></div>
          <div v-if="loginPage" class="content">
            <ul class="common-form">
              ...
              <li>
                <div class="input">
                  <input type="password" v-model="ruleForm.userPwd" @keyup.enter="signIn" placeholder="密码">
                </div>
              </li>
              <li style="text-align: right" class="pr">
                <span class="pa" style="top: 0;left: 0;color: #d44d44">{{ruleForm.errMsg}}</span>
                <a href="javascript:;" style="padding: 0 5px" @click="loginPage = false">注册 HigherLoft ID</a>
              </li>
            </ul>
            <div>
              <ctm-button text=登录 :classStyle="isLoginOk" @btnClick="signIn" class="btn"></ctm-button>
            </div>
          </div>
          <div class="registered" v-else>
            <h4>注册 HigherLoft ID</h4>
            <div class="content" style="margin-top: 20px;">
              ...
              <div>
                <ctm-button :classStyle="isRegOk" text="注册" class="btn" @btnClick="signUp"></ctm-button>
              </div>
              <ul class="common-form pr">
                ...
                <li style="text-align: center;line-height: 48px;margin-bottom: 0;">
                  <span>如果您已拥有 HigherLoft ID，则可在此</span>
                  <a href="javascript:;"
                    style="margin: 0 5px"
