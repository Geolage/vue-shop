    ...
    <div>
      <header class="w">
        <div class="w-box">
          <div class="nav-logo">
            <h1>
              <router-link to="/" title="Welcome to HigherLoft Shop">HigherLoftShop</router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
                  ...
                  <div class="nav-user-list">
                    <div class="full" v-show="totalNum">
                      ...
                      <div class="nav-cart-total"><p>共 <strong>{{totalNum}}</strong> 件商品</p> <h5>合计：<span
                        ...
                        <h6>
                          <ctm-button classStyle="main-btn"
                                    style="height: 40px;width: 100%;margin: 0;color: #fff;font-size: 14px;line-height: 38px"
                                    text="去购物车" @btnClick="toCart"></ctm-button>
                        </h6>
                      </div>
                    </div>
                    <div v-show="!totalNum" style="height: 300px;text-align: center" class="cart-con">
                      <p>Oooops！购物车里一样东西也没有!</p>
                    </div>
                  </div>
                </div>
